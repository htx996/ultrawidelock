		       ...
		       uint8_t *plainText, size_t &plainTextLength)
{
	 ...
	 * wired): the credential blob is crypto-agnostic and calls this for EVERY BLE message, so a
