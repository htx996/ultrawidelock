...
Internal flash, app core (`apps/nrf5340dk-lock/overlays/pm_static.yml`):
...
| Partition | Address | Size | Purpose |
|---|---|---:|---|
| `external_nvs` | `0x00000` | 128 KiB | credential reader storage, AEAD-encrypted with rollback protection (`CONFIG_DOOR_LOCK_EXTERNAL_NVS`) |
